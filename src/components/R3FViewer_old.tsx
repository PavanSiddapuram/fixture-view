  ...
  React.useEffect(() => {
    if (actualRef.current && camera && size) {
      ...
      if (dimensions && (dimensions.x || dimensions.y || dimensions.z)) {
        ...
        console.log('Model scaled to specified dimensions:', dimensions);
      }
...
function Scene({
  ...
  setCurrentTransformMode: (mode: 'translate' | 'rotate' | 'scale') => void;
  ...
  }, [transformEnabled, setTransformEnabled]);
  ...
  }, [camera, setTransformEnabled, setModelTransform, setModelDimensions]);
...
const R3FViewer: React.FC<R3FViewerProps> = ({ 
  ...
  // Transform state - moved to parent level for UI access
    ...
    <div className="w-full h-full relative">
      ...
      >
        <Scene
          ...
          setTransformEnabled={setTransformEnabled}
          currentTransformMode={currentTransformMode}
          setCurrentTransformMode={setCurrentTransformMode}
          modelTransform={modelTransform}
          setModelTransform={setModelTransform}
        />
      </Canvas>

      {/* Transform Controls UI - Outside Canvas for proper DOM rendering */}
      <TransformControlsUI
        transformEnabled={transformEnabled}
        currentTransformMode={currentTransformMode}
